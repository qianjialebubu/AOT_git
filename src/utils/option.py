...
# data specifications 
parser.add_argument('--dir_image', type=str, default='D:\\file\\program_data\\deeplearning\\Linux\\AOT1',
                    help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default='D:\\file\\program_data\\deeplearning\\Linux\\AOT1\\testing_mask_dataset_10',
                    help='mask dataset directory')
parser.add_argument('--data_train', type=str, default='celeba-64',
                    help='dataname used for training')
parser.add_argument('--data_test', type=str, default='celeba_64',
...
parser.add_argument('--save_every', type=int, default=2e4,
